...
# Menu com os modos local e contra IA:
gcc src/main.c src/menu.c src/partida.c src/jogador_teclado.c src/jogador_remoto.c src/JogadorIA.c src/regra_IA.c src/tabuleiro.c -o build/jogo-da-velha
...
| --- | --- |
| `build/jogo-da-velha` | Menu com os modos local (dois jogadores) e contra IA. |
